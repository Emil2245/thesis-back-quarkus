...
| I-07 | 13–14 | Presupuesto (capítulos, rubros, totales, versionado, validación) | 🟡 **PLANNED / READY** — 7 planes ejecutables (019–025) redactados en [`modulos/05-presupuesto/00.md`](modulos/05-presupuesto/00.md); implementación pendiente. Activa el módulo profundo `recalculo` (ADR nuevo) e introduce `public_id` UUIDv7 en `capitulo` y `rubro` (V008 estructural). Cronograma (P-33…P-36) y export SERCOP (P-37) fuera de alcance I-07 |
...
precedente cierra CI-verde). Los planes de I-07 ya están redactados como
**PLANNED / READY** en [`modulos/05-presupuesto/`](modulos/05-presupuesto/00.md)
(7 planes ejecutables 019–025 al 2026-08-31); la ejecución efectiva queda pendiente.
