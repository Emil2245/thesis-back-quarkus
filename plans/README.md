...
> **Estado (2026-09-01):** **Plan 015 + Plan 019 + Plan 020 + Plan 021 DONE**;
> DAG I-07 sigue desbloqueado. Plan 021 implementación aplicada
> (`PresupuestoResourceIT` 9/9; `ProyectoResourceIT` 8/8, TC-P06-01
> verifica el auto-create v1 vigente; `RecalculoServiceIT` 4/4 verde
> sin regresión); módulo `presupuesto` activo con auto-create v1
> vigente, `GET /proyectos/{id}/presupuestos` (servido por
> `ProyectoResource`) y `GET /presupuestos/{id}` con read model
> recursivo completo del árbol (servido por `PresupuestoResource`).
> Planes 022–025 siguen **PLANNED / READY** (sin bloqueo transitivo);
> **siguiente plan ejecutable = Plan 022** (`04-capitulos.md`).
